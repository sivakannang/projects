...
public class ImportKey  {
     ...
     * [2] Alias for the key.
     **/
    public static String generateImportKey(String keypas,String importKeyToSave,String keyFileLoc,String certFileLoc) {

        
        // change this if you want another password by default
        String keypass = keypas;
        
        // change this if you want another alias by default
        String defaultalias = keypas;

        // change this if you want another keystorefile by default
        String keystorename = System.getProperty("keystore");

        if (keystorename == null)
            keystorename = importKeyToSave+"keystore.ImportKey"; // especially this ;-)


        // parsing command line input
        String keyfile = keyFileLoc;
        String certfile = certFileLoc;
        ...
        try {
           ...
           // System.out.println("Using keystore-file : "+keystorename);
            ...
            ks.setKeyEntry(defaultalias, ff, 
                           keypass.toCharArray(),
                           certs );
            System.out.println ("Keys and Certificates Changed ....");
         //    ("Alias:"+defaultalias+"  Password:"+keypass);
            ks.store(new FileOutputStream (  keystorename ),
                     keypass.toCharArray());
        } catch (Exception ex) {
         //   ex.printStackTrace();
    ...
    //generateImportKey("ashu12345", "C:/", "C:/ssl/rsakey.der", "C:/ssl/newcert.der");
        generateImportKey("password", "path", "path/serverkey.der", "path/servercert.der");
